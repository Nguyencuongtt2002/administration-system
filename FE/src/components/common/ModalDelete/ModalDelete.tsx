...
const DialogDelete = ({ tableIdDelete, setTableIdDelete, onConfirm, title, description }: Props) => {
    ...
    >
      <DialogContent className='sm:max-w-md flex flex-col items-center gap-4'>
        ...
        <DialogHeader className='flex justify-center items-center'>
          <DialogTitle className='text-xl font-semibold text-gray-400'>{title || t('common_title_delete')}</DialogTitle>
        ...
        <DialogFooter className='flex w-full  lg:justify-center gap-4'>
          <DialogClose asChild>
            <Button type='button' variant='outline' className='bg-gray-700 text-white hover:bg-gray-600'>
              Cancel
            </Button>
          </DialogClose>
          <Button
